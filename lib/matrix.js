...
*	Evaluates the probability density function (PDF) for a Inverse Gamma distribution with shape parameter `alpha` and scale parameter `beta` for each matrix element.
*
