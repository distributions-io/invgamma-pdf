...
describe( 'distributions-inverse gamma-pdf', function tests() {
	...
	it( 'should compute the Inverse Gamma pdf when provided a number', function test() {
	...
	it( 'should evaluate the Inverse Gamma pdf when provided a plain array', function test() {
	...
	it( 'should evaluate the Inverse Gamma pdf when provided a typed array', function test() {
	...
	it( 'should evaluate the Inverse Gamma pdf element-wise and return an array of a specific type', function test() {
	...
	it( 'should evaluate the Inverse Gamma pdf element-wise using an accessor', function test() {
	...
	it( 'should evaluate the Inverse Gamma pdf element-wise and deep set', function test() {
	...
	it( 'should evaluate the Inverse Gamma pdf element-wise when provided a matrix', function test() {
	...
	it( 'should evaluate the Inverse Gamma pdf element-wise and return a matrix of a specific type', function test() {
		var validationData = require( './fixtures/matrix.json' ),
			mat,
			out,
			d1,
